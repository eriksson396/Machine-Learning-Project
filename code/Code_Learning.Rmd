...
# #Harvard General Inquiry Database
# data(DictionaryGI)
...
loughran <- loughran[c("positive","uncertainty","strong_modal","weak_modal")]
loughran$positive <- tolower(loughran$positive)
loughran$uncertainty <- tolower(loughran$uncertainty)
loughran$strongmodal <- tolower(loughran$strong_modal)
loughran$weakmodal <- tolower(loughran$weak_modal)
